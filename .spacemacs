...
values."
  (setq-default
   ...
   '(
     ...
     ;; to install universal ctags
     ;; `'gtags --gtagslabel=ctags`' at base of project
     csv
     sql
     ;; ----------------------------------------------------------------
...
you should place your code here."
  ...
  (setq geben-path-mappings '(("/home/justin/gfs/Content-Hub/app/drupal8/app" "/var/www/app")))
  ...
  ;; TODO this is a quick fix for something that should be fixed in the next spacemacs release
  ...
  ;;   (setq org-agenda-files '("/media/justin/data/Documents/journal/" "/media/justin/data/Documents/gfs-notes/"))
  ;;   (push (org-projectile:todo-files) org-agenda-files)
  ;;   (setq org-default-notes-file '("/media/justin/data/Documents/notes.org"))
